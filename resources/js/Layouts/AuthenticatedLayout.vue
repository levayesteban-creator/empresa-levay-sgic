            ...
            <nav class="border-b border-gray-100 bg-white">
                    ...
                    <div class="flex h-16 justify-between">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink :href="route('auditoria.index')" :active="route().current('auditoria.*')">
                                    Auditoría
                                </NavLink>
                            </div>
                        </div>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': !showingNavigationDropdown}" class="sm:hidden">
                    <div class="space-y-1 pb-3 pt-2">
                        ...
                        <ResponsiveNavLink :href="route('categorias.index')" :active="route().current('categorias.*')"> Categorías </ResponsiveNavLink>
                        <ResponsiveNavLink :href="route('proveedores.index')" :active="route().current('proveedores.*')"> Proveedores </ResponsiveNavLink>
                        <ResponsiveNavLink :href="route('auditoria.index')" :active="route().current('auditoria.*')"> Auditoría </ResponsiveNavLink>
                    </div>

                    <div class="border-t border-gray-200 pb-1 pt-4">
                        <div class="px-4">
                            <div class="text-base font-medium text-gray-800">{{ page.props.auth?.user?.name || 'Usuario' }}</div>
